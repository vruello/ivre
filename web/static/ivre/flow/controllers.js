...
ivreWebUi
    .controller('IvreFlowCtrl', function ($scope, $http, $compile, $timeout,
	    ...
	    // such as DST or leap years...
            ...
            // time in milliseconds between the first and the last timeslot date.
            var timerange = dateextent.reduce(function(x, y) {return y - x});
	    ...
	    to_delete_indexes.forEach((to_delete) => {
            ...
            vis.append("g")
                ...
                .attr("fill", "white")
                .attr("fill-opacity", 0)
                .attr("width", function(d, i) { return width * (durations[d] || 1); })
                .attr("height", dr_h)
